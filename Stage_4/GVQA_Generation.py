...
print(f"Number of files: {len(subtitles)}")
...
system_prompt = """
You will get a concluion of the video. Please provide four choices for the question you are asked.
The question should prevent to ask the general information of the video.
